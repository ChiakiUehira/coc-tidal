...
async function activate(context) {
  import_coc2.window.showMessage(`coc-tidal works!`);
  context.subscriptions.push(import_coc2.commands.registerCommand("coc-tidal.Command", async () => {
    import_coc2.window.showMessage(`coc-tidal Commands works!`);
  ...
  }), import_coc2.workspace.registerKeymap(["n"], "tidal-keymap", async () => {
